...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root
      ...
      data-viewport={viewport === "inline" ? "false" : "true"}
      {...props}
    >
      {children}
      {viewport === "default" ? (
...
function NavigationMenuViewport({
  ...
  return (
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "relative h-(--positioner-height) w-full origin-(--transform-origin) overflow-hidden rounded-lg border bg-popover text-popover-foreground shadow outline-none ring-1 ring-foreground/10 transition-[width,height] duration-300",
        className
      )}
